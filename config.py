...
# =============================
TRAILING_ACTIVATION_PCT = float(os.getenv("TRAILING_ACTIVATION_PCT", 0.3))
...
# =============================
TSI_PRIMARY_TRIGGER_PCT = float(os.getenv("TSI_PRIMARY_TRIGGER_PCT", 0.3))       # activation threshold %
